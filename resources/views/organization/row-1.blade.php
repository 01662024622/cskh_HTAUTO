        ...
        <li>
            <a href="#">
                <div class="label row" style="padding-right: 0">
                    ...
                    <div class="col-12 header">Trưởng phòng HCNS</div>
                    <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                        ...
                        <div class="col-8" style="font-size: 10px;text-align: left;padding-right: 0;margin-right: 0px">
                            ...
                            <p><i class="fa fa-envelope-o" aria-hidden="true"></i> test@htauto.com.vn</p>
                            <p><i class="fa fa-skype" aria-hidden="true"></i> skype link</p>
                        </div>
                    </div>
                </div></a>
            <ul class="row" style="max-width: 2700px">


                <li class="col" style="max-width: 225px" style="max-width: 225px">
                    <a href="#"><div class="label row" style="padding-right: 0">
                            ...
                            <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                                ...
                                <div class="col-12" style="font-size: 10px;text-align: left;padding-right: 0;margin-right: 0px">
                                    <p><i class="fa fa-user" aria-hidden="true"></i>Tôi là B</p>
                                    <p style="font-size: 8px;"><i class="fa fa-rss" aria-hidden="true"></i> <i>Nhạc trưởng kết nối sáng tạo</i></p>
                                    <p><i class="fa fa-envelope-o" aria-hidden="true"></i> test@htauto.com.vn</p>
                                    <p><i class="fa fa-skype" aria-hidden="true"></i> skype link</p>
                                </div>
                ...
                <li class="col" style="max-width: 225px">
                    <a href="#"><div class="label row" style="padding-right: 0">

                            <div class="col-12 header">Nhân viên IT</div>
                            <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                                <div class="col-12">
                                    <img src="0.jpg" class="img-fluid" alt="">
                                </div>
                ...
                <li class="col" style="max-width: 225px">
                    <a href="#"><div class="label row" style="padding-right: 0">
                            ...
                            <div class="col-12 header">X</div>
                            <div class="col-12 row" style="margin-right: 0;padding-right: 0">
                                <div class="col-12">
                                    <img src="0.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-12" style="font-size: 10px;text-align: left;padding-right: 0;margin-right: 0px">
                                    <p><i class="fa fa-user" aria-hidden="true"></i>Tôi là C</p>
                                    <p style="font-size: 8px;"><i class="fa fa-rss" aria-hidden="true"></i> <i>Nhạc trưởng kết nối sáng tạo</i></p>
                                    <p><i class="fa fa-envelope-o" aria-hidden="true"></i> test@htauto.com.vn</p>
                                    <p><i class="fa fa-skype" aria-hidden="true"></i> skype link</p>
                                </div>
